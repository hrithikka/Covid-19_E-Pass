...
account_sid='AC0cc2875dff85dfdec759b9228d161abf'#ur acct_id in single quotes
auth_token='a4a2541f30f1873c0e29195cd400f390'#ur acct_token in single quotes
...
def login_registration_dtls():
    ...
    if travel_pass<10 and request.method=='POST':
        status='CONFIRMED'
        client.messages.create(to="whatsapp:+919502924380",from_="whatsapp:+14155238886",
        ...
        client.messages.create(to="whatsapp:+919502924380",
